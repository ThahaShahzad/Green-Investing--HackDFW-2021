  ...
  return (
    <>
      ...
      <Container mt='20' mb='40'>
        ...
        <Text>
          ESG is a metric used to measure how "green" a company is based on their environmental, social, and corporate
          governance practices. Each category is given a score and the final ESG score is their sum. Learn more:
